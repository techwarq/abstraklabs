    ...
    <main className="min-h-screen bg-[#F5F5F3] text-black">
      ...
      <div className="relative max-w-[1440px] mx-auto border-x border-black/[0.08] bg-[#F5F5F3]">
        ...
        <section className="px-6 lg:px-8 py-10 border-b border-black/[0.08]">
          ...
          <p className="mono text-[11px] tracking-[0.14em] uppercase font-bold text-[#FF4B00] mt-3">Not client projects — internal demos to show how work is done</p>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-black/[0.08] border-b border-black/[0.08]">
          {samples.map((s) => (
            <Link key={s.href} href={s.href} className="bg-white p-6 lg:p-7 hover:bg-[#F5F5F3] transition-colors group">
              ...
              <h2 className="text-[16px] font-bold tracking-tight uppercase mt-4 group-hover:text-[#FF4B00]">{s.title} →</h2>
              ...
              <div className="mt-4 grid grid-cols-2 gap-px bg-black/[0.08] border border-black/[0.08] mono text-center">
                ...
                <div className="bg-white py-2 border-l border-black/[0.08]">
                  ...
                  <div className="text-[12px] font-bold text-[#FF4B00]">{s.cost}</div>
                </div>
              </div>
